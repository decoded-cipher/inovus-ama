    ...
    <div class="lg:block">
      ...
      <div class="mt-3">
        <button
          :disabled="isLoading || isOffline"
          :class="[
            'w-full p-3 text-xs sm:text-sm text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded sm:rounded-xl transition-all duration-200 flex items-center justify-center gap-2',
            (isLoading || isOffline) && 'opacity-50 cursor-not-allowed'
          ]"
